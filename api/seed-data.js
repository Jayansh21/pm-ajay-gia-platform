...
// POST /api/seed-data - Initialize database with demo data
  ...
  if (req.method === 'POST') {
    try {
      ...
      db.get('SELECT COUNT(*) as count FROM beneficiaries', (err, row) => {
        ...
        if (row.count > 0) {
          return res.json({ 
            message: 'Database already seeded with demo data',
        ...
        beneficiaries.forEach((beneficiary, index) => {
          const params = [
            ...
            beneficiary.eligibility_score, Math.random() > 0.3 ? 1 : 0 // Random verification
          ];
  ...
  const projects = [
    {
      ...
      description: 'Establishing organic vegetable farming with modern irrigation techniques',
    ...
    },
    {
      ...
      description: 'Setting up a small tailoring business with modern equipment',
      category: 'Income Generation',
    ...
    },
    {
      ...
      description: 'Advanced construction and masonry skills training program',
    ...
    },
    {
      ...
      description: 'Establishing a community kitchen for local events and catering',
      category: 'Income Generation',
...
function insertTrainingPrograms(db, res) {
  const trainingPrograms = [
    ...
    },
    {
      ...
      description: 'Business planning and entrepreneurship skills training',
      category: 'Skill Development',
      duration_weeks: 12,
      max_participants: 20,
